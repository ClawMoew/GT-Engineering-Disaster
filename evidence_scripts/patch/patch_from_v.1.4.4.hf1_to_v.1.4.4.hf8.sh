...
# Software Patch from v.1.4.4.hf1 to v.1.4.4.hf8. 
...
# 08. stop wrapper api docker. 
# 09. modify docker-compose file for wrapper api. 
# 10. get mac list. 
# 11. start wrapper api docker. 
# 12. start web api docker. 
# 13. start auth server docker. 
...
# check if use sudo. 
funcChkIsNotSudo $patchScript_144hf1_144hf8
...
# 08. stop wrapper api docker. 
echo "08. Stop Wrapper API...";
funcDockerStopWrapperApi


# 09. modify docker-compose file for wrapper api. 
echo "09. Modify Docker Compose File for Wrapper API...";
if [ -f $install_path_wrap_api/$file_docker_compose_file ]; then
    cp $install_path_wrap_api/$file_docker_compose_file $install_path_wrap_api/$file_docker_compose_file_patch_bak
    if [ -f $file_docker_compose_file_wrapper_api ]; then
        ...
        echo "Modify Docker Compose File for Wrapper API... Failed!  ";
        echo "Unable to find file: $file_docker_compose_file_wrapper_api";
        echo "";
        exit 1
    fi
    echo "Modify Docker Compose File for Wrapper API... done";
    echo "";
else
    echo "Modify Docker Compose File for Wrapper API... Failed!  Unable to find file: $install_path_wrap_api/$file_docker_compose_file";
    echo "";
    exit 1
fi
...
# 11. start wrapper api docker. 
echo "11. Start Wrapper API...";
funcDockerStartWrapperApi


# 12. start web api docker. 
echo "12. Start Web API...";
funcDockerStartWebApi


# 13. start auth server docker. 
echo "13. Start Auth Server...";
